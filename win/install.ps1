...
winget import --import-file "\\wsl.localhost\Ubuntu\home\$wsl_username\github\dotfiles\win\winget.json" --disable-interactivity --accept-package-agreements
...
$powertoys_backup_dir = "\\wsl.localhost\Ubuntu\home\$wsl_username\github\dotfiles\win\powertoys"
# cspell:ignore hkcu
